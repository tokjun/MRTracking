...
class MRTrackingWidget(ScriptedLoadableModuleWidget):
  ...
  def setup(self):
    ...
    #  trackingDataSelectorLayout.addRow("Catheter: ", self.catheterComboBox)
    ...
    #  trackingDataSelectorLayout.addRow("Source: ", self.trackingDataSelector)
    #  
...
class MRTrackingLogic(ScriptedLoadableModuleLogic):
  ...
  #  
  #    # Egram data
  #    if (egramPoint != None) and (td.pointRecording[index] == True):
